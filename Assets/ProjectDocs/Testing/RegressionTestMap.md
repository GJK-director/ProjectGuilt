...
|---|---|---|---|
| 103 | Legacy Mode103 → Shared Production Fixture Consumer → Shared synthetic factories → 28 legacy checks retained；Enemy Intent cycle、target slot、当前 Definition/ownership 引用、legacy fallback、250% damage 相关回归 | EnemyIntent、Bootstrap、Resolution | LEGACY_ACTIVE |
